...
export class EventService {
  ...
  public getEvents() {
    /**
     * make this EVENTS data fetch behave asynchronously
     * as if it was been loaded from a server.
     * This behaviour is possible via Observable
     */
    let subject = new Subject();

    //mimic asynchronous behaviour using this subject instead of returning EVENTS statically
    setTimeout(
      () => {
        subject.next(EVENTS);
        subject.complete();
      ...
      100 //increase to say 2000 to visualize effect
    );
